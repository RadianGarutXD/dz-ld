...
# coded by ZEPTA INDONESIA

# reedit & translate to indonesia by RADIAN
...
def masuk():
        ...
        print("Bingung ? cek Channel Master Radian indonesia")
        ...
        if "mbasic_logout_button" in str(ismi):
                ...
                if "Apa yang Anda pikirkan sekarang" in str(ismi):
                        ...
                        print("# Ganti Bahasa, Mohon Tungguan goblok!!")
